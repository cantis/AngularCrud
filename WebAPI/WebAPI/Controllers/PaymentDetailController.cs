...
namespace WebAPI.Controllers
{
    ...
    public class PaymentDetailController : ControllerBase
    {
        ...
        // GET: api/PaymentDetail - Get list of all PaymentDetails
        [HttpGet]
        ...
        // Get: api/PaymentDetail/5 - Get a spicific PaymentDetail
        [HttpGet("{id}")]
        ...
        // PUT: api/PaymentDetail/5 - Update Existing 
        [HttpPut("{id}")]
        ...
        // POST: api/PaymentDetail - Insert new PaymentDetail
        [HttpPost]
        ...
        // DELETE: api/PaymentDetail/5 - Delete a spicific PaymentDetail
        [HttpDelete("{id}")]
        ...
        // Check and see if a given payment detail exists. 
